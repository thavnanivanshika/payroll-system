...
Public Class SALARY_EDIT
    ...
    Private Sub LoadDataIntoDataGridView()
        Try
            ...
            DataGridView1.DataSource = dataSet.Tables("SALARY")
            connection.Close()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If DataGridView1.SelectedRows.Count > 0 Then
            Try
                ...
                Dim updateQuery As String = "UPDATE SALARY SET "
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If DataGridView1.SelectedRows.Count > 0 Then
            Try
                ...
                Dim connection As New SqlConnection(connectionString)
                Dim command As New SqlCommand("DELETE FROM SALARY WHERE EMPLOYEE_CODE = @EMPLOYEE_CODE", connection)
